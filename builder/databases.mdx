...
* Test your database by using your Page/Function/Component in Demo mode.
  ...
  * From the
    ...
    [three dot menu](/builder/controls#top-nav)

    on the Page/Function/Component, you can go to Linked Data to see databases referenced by the element. This provides quick access to the database.
...
* Use it in the builder from a Page, Function, or Component with
...
* [Three dot menu](/builder/controls#three-dot-menu)

  on a Page/Function/Component - Linked Data
...
* Contact support for manual changes. Email us at

  [hello@create.xyz](mailto:hello@create.xyz)
