...
<Frame caption="Database Overview Video" id="database-overview-video">
  <iframe
    width="100%"
    height="400"
...
Every Create project includes a free database. As you chat with Create, it handles all database details - from designing the structure to writing the code that enables your application to save and retrieve data.
...
Create automatically updates your database structure and how your application retrieves and stores data as you chat.
...
If you say "Make me a tasks app", Create:
...
As you continue describing your application, Create updates your database structure, Functions, and Pages to match your requirements.
...
<AccordionGroup>
  ...
  Ask the builder to add sample data and be specific about its purpose and location. <a href="#database-overview-video">See video here</a> for a demo of this. 
</AccordionGroup>
