...
1. By hand:
   ...
   * Make sure you're in [Select Mode](/builder/controls#select-mode)
...
2. By prompt:
   ...
   * [Publish](/publish-and-share/publish) your app and [choose routes](/publish-and-share/publish#routes) for each page (e.g. `/about`)
