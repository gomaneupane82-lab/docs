...
Create transforms your natural language descriptions into fully functional websites, mobile apps, and full-stack web applications. Simply describe what you want, and Create automatically generates pages, features, and components for you.
...
Create immediately begins translating your instructions into a functional foundation:

![Detailing Gi](/images/detailing.gif)

## Core building blocks

Create constructs your application using these fundamental elements:
...
<Card title="Essentials" icon="apple-core" horizontal href="/essentials">
  Master the core concepts to get started with Create
</Card>
