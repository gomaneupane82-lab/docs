...
### You chat with Create to build sites, mobile and full-stack web apps.
...
As you update and add features you'll want to test those. In the case of a mobile app we have an easy to use QR code system that let's me preview directly on my mobile device, as often as I need.
...
As you work to finalize your website or mobile app you'll be able to publish it to different routes based on your desired final product. \
\
Want to quickly publish your website or blog with Create? [Read on here.](/publish-and-share/publish)

Want to publish to the iOS App Store (in beta)? [Read on here.](/builder/mobile)

**Learn more**

<Card title="Essentials" icon="apple-core" horizontal href="/essentials" cta="The core of what you need to know to build effectively">
  The core of what you need to know to get started with Create
</Card>

<Card title="Prompting" icon="thought-bubble" horizontal href="/prompting">
  How to talk to the AI to get effective outcomes or quickly correct issues
</Card>

### Common terms and language when building in Create

<Expandable title="Glossary of common terms in Create" defaultOpen="true">
