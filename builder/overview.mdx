...
### You chat with Create to build sites and full-stack web apps. Create automatically layers in pages, features and components to build for you. 

**How you get started is based on your initial prompt. **

<Tip>
  What is a 1-3 sentence summary of your ideal app or website, try to summarize its core functions into your initial prompt. Remember to be clear about desired type, "Mobile App that does x" is different than "I want a site that does x" 
</Tip>

For example, if I've been hoping to build a mobile application for my detailing business, I might say:

```
Create a mobile app that lets customers book time with me for detailing their cars.
```

This sets in motion a build that will begin to take shape right in front of you:

![2025 07 2415 30 40 Gi](/images/2025-07-2415.30.40.gif)

**The AI Agent begins to translate your instruction into the foundation of your desired mobile app. **

As it begins to write the code of your application its working with specific elements:
...
I can now work to refine the initial build by interacting with it directly in the builder. Rarely are you going to have a complete feature ready app with just one prompt, but as you can see in the GIF above, we're pretty close\!
...
**Now to test the photo function, I'm gonna use **[**ExpoGo**](/builder/mobile)** to preview it live on my phone**
...
<CardGroup cols={2}>
  <Card title="Pages" icon="rectangle-vertical-history" href="/builder/pages">
    Screens of your app
  </Card>
  <Card title="Integrations" icon="puzzle-piece" href="/builder/integrations">
    Add AI and other superpowers in seconds
  </Card>
  <Card title="Databases" icon="database" href="/builder/databases">
    Learn how to store your app data.
  </Card>
  <Card title="User Accounts" icon="user" href="/builder/user-accounts">
