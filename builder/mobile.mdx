...
This feature is in beta for early access members and under active development. [Sign up at beta.create.xyz](https://beta.create.xyz) and wait for confirmation from our team. 

<Warning>
  This is a Beta - Mobile app support is rapidly evolving. You might encounter limitations with certain features or device capabilities. Your real-world examples help us prioritize improvements. Try building different apps and tell us what works and what breaks.
</Warning>
...
- **(Coming Soon) Instant App Store and Play Store submission** - Publish your app to the App Store and Play Store from Create
...
<Steps>
  <Step title="Join Early Access">
    [Sign up at beta.create.xyz](https://beta.create.xyz) and wait for confirmation
  </Step>
...
Create generates React Native code and partners with ExpoGo for app preview. It generates app that can work on either iOS or Android, and use device capabilities like camera, location, etc.
...
<Warning>
  This feature is under active development and this article is incomplete, updates ongoing
</Warning>
  ...
  <Step title="Prepare Your App">
    ...
    2. Obtain your [Apple Developer Account](https://developer.apple.com/account)
       ...
       <Warning>
         ...
         \
         You will not be able to publish to the app store or TestFlight while your Apple Developer Account is processing or verifying. You'll receive an email from Apple stating "Welcome to AppConnect" that should indicate you are aready to use your developer account. 
       </Warning>
