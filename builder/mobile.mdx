...
<Note>
  ...
  Submitting to the App Store and TestFlight <u>requires</u> an Apple Developer Account which requires a yearly subscription. Create an Apple Developer account using your Apple ID right [here](https://developer.apple.com/account).
</Note>
