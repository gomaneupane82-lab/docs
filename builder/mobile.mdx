...
Create will soon support prompt to mobile apps. You can launch your app on iOS and Android. This feature is in beta for early access members and under active development.
...
<Steps>
  <Step title="Join Early Access">
    Email [hello@create.xyz](mailto:hello@create.xyz) to request access to the new mobile beta
  </Step>
