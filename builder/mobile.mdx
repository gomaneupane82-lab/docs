...
<Steps>
  <Step title="Join Early Access">
    Email [hello@create.xyz](mailto:hello@create.xyz) to request access to the new mobile capable builder
  </Step>
...
## Publishing to iOS App Store via [TestFlight](https://developer.apple.com/testflight/)

<Warning>
  This feature is under active development and this article will be update frequently 
</Warning>

TestFlight is Apple's Beta channel for testing ahead of your eventual app store launch.

![Lockup Ipad Iphone Testflight 2x Web](/images/lockup-ipad-iphone-testflight_2x.webp)

<Note>
  Submitting to the TestFlight and the App Store requires an Apple Developer Account which requires a yearly subscription. Create an Apple Developer account using your Apple ID right [here](https://developer.apple.com/account).
</Note>
