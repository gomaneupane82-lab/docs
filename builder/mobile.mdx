...
We're building a streamlined way to submit your app to the App Store and Google Play from Create.

In the meantime, you can export your code and publish using Expo's tools.
