...
Search and summarize movie and TV show data with the MovieDB API.
...
Access comprehensive Pokémon data including stats, abilities, and evolution chains.
...
<Tip>
  ...
  [Full steps here](/integrations/pokeapi) (1 min set up time)
</Tip>

#### Spotify

Access millions of songs, playlists, and user listening data through Spotify's API.
...
<Tip>
  You'll need to set up your own Spotify API credentials to use this integration in Create.
  
  [Full steps here](/integrations/spotify) (2 mins set up time)
</Tip>
...
Integrate chat and notification features with LINE's messaging platform

Example prompts:

* `Send order confirmations via /Line`
* `Build a customer support chatbot with /Line`
* `Create a broadcast system using /Line`

<Tip>
  You'll need to set up LINE channel credentials to use this integration in Create.
  
  [Full steps here](/integrations/line) (2 mins set up time)
</Tip>

#### Resend

Send transactional emails and manage email campaigns through Resend's email API

Example prompts:

* `Send order confirmation emails with /Resend`
* `Build a password reset flow using /Resend`
* `Create a newsletter system with /Resend`

<Tip>
  You'll need to set up your Resend API key to use this integration in Create.
  
  [Full steps here](/integrations/resend) (2 mins set up time)
</Tip>

#### NeverBounce

Verify email addresses in real-time to improve deliverability and protect sender reputation.

Example prompts:

* `Validate this email address with /NeverBounce`
...
<Tip>
  You'll need to set up your own NeverBounce API key to use this integration in Create.
  
  [Full steps here](/integrations/neverbounce) (2 mins set up time)
</Tip>

#### ElevenLabs

Generate natural-sounding voices and convert text to lifelike speech using ElevenLabs' AI voice technology.

Example prompts:

* `Convert this text to speech using /ElevenLabs`
  
* `Create an audio narration with /ElevenLabs using a British accent`

* `When using /ElevenLabs, save the audio file and add a play button`

<Tip>
  You'll need to set up your own ElevenLabs API key to use this integration in Create.
  
  [Full steps here](/integrations/elevenlabs) (2 mins set up time)
</Tip>
...
<Tip>
  ...
  [Full steps here](/integrations/flux) (2 mins set up time)
</Tip>

#### Rentcast

Access comprehensive real estate data and rental market analytics.
...
<Tip>
  You'll need to set up your own Rentcast API key to use this integration in Create.
  
  [Full steps here](/integrations/rentcast) (2 mins set up time)
</Tip>

#### Brandfetch

Access company logos, colors, and brand assets for millions of companies.
...
<Tip>
  You'll need to set up your own Brandfetch API key to use this integration in Create.
  
  [Full steps here](/integrations/brandfetch) (2 mins set up time)
</Tip>