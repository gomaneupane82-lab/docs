...
You can add integrations to your [Pages](/create/builder-add-ons/pages), [Components](/create/builder-add-ons/components), or [Functions](/create/builder-add-ons/functions). When you add an integration, you'll see a special chip in your chat. Create adds the integration code to your page/component/function.
...
[PreviousPages](/create/builder-add-ons/pages)[NextComponents](/create/builder-add-ons/components)
