...
<Frame caption="Creating a new Function">
  <img src="/images/functions/new.gif" />
</Frame>
...
<Frame caption="Using an integration in a Function">
  <img src="/images/functions/use-integration.gif" />
</Frame>
...
<Frame caption="Using a Function">
  <img src="/images/functions/use-in-page.gif" />
</Frame>
...
<div className="relative aspect-video">
  <iframe
    ...
    title="Create Tutorial: Connecting to External APIs"
...
<div className="relative aspect-video">
  <iframe
    ...
    title="How to make a tool that uses Zapier in Create"
    className="absolute top-0 left-0 w-full h-full"
    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
    allowFullScreen
  />
