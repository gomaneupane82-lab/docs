...
<Warning>
  This information is for a legacy version of Create. Function creation will soon be natively handled by the AI builder using simple instruction during your project editing. 
</Warning>
