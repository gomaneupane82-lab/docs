...
* **Protected actions** - Gate [Functions](/create/builder-add-ons/functions) behind authentication
...
* [Functions](/create/builder-add-ons/functions) - Add custom authentication logic that looks at the UserDB to do different actions

* [Pages](/create/builder-add-ons/pages) - Create protected routes

* [Publishing](/create/publish-and-share/publish) - Deploy your authenticated app

[PreviousDatabases (beta)](/create/builder-add-ons/databases-beta)[NextUploads](/create/builder-add-ons/uploads)
