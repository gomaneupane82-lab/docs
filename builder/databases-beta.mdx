...
For complex database needs, you can connect external databases (like Supabase or Xano) using [Functions](/create/builder-add-ons/functions).
...
* Test your database by using your Page/Function/Component in Demo mode.
  ...
  * From the 3 dot menu on the Page/Function/Component, you can go to Linked Data to see databases referenced by the element. This provides quick access to the database.
...
* 3 dot menu on a Page/Function/Component - Linked Data
...
[PreviousFunctions](/create/builder-add-ons/functions)[NextUser Accounts](/create/builder-add-ons/user-accounts)
