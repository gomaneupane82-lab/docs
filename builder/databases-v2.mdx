...
Here are some common ways to troubleshoot common database errors:

### Data isn't saving 

If data isn't saving when you use your app, there's 3 places it might be failing:

1. The database structure is wrong
2. The function that saves data is wrong. 
3. The UI isn't connected to the function that saves data. 
