...
* **User specific content** - Allow profile pictures and submissions with [User Accounts](/create/builder-add-ons/user-accounts)

### Adding Uploads

Add uploads to any [Page](/create/builder-add-ons/pages), [Component](/create/builder-add-ons/components), or [Function](/create/builder-add-ons/functions) by prompting Create to handle uploads:
...
[PreviousUser Accounts](/create/builder-add-ons/user-accounts)[NextPublish](/create/publish-and-share/publish)
