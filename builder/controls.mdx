...
- **Discussion Mode** - chat without making edits. It can be important at times to prevent edits to your work and be able to ask questions of the builder about status, approach or specific features without allowing it to alter your current design. Read only mode is here. 

![Screenshot2025 06 06at12 45 21PM Pn](/images/Screenshot2025-06-06at12.45.21PM.png)

- Put the chat into Discussion Mode by clicking on the speech bubble icon labeled "Discuss" in the lower left corner of the chat window
- While in Discussion Mode the builder is intentionally prevented from making changes to your work
- You can ask any questions about your build, get information on a function or a page. Remember that if you want to start editing again, you just need to toggle Discussion Mode Off by clicking on the icon again. 
...
![Screenshot2025 06 04at1 09 33PM Pn](/images/Screenshot2025-06-04at1.09.33PM.png)
