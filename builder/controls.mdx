...
- Return to Dashboard - head back to your main account page in Create
...
- Author and maintain Custom Instructions - shape the way the builder interacts with you and your project. This is an advanced feature not generally required for daily use. See community examples of Custom Instructions [**here.**](https://www.create.xyz/custom-instructions)