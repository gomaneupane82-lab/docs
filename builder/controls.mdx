...
Orientation through the Create builder.

<Frame caption="Create builder interface showing the main canvas, chat, and key controls">
  <img src="/images/create/builder-add-ons/files%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FhtL7VuGp0gBcXZ6RdKx1%252Fuploads%252FPDZVJTA1e5wruA47GAto%252Fimage.png" />
</Frame>
...
* [**Invite**](/create/publish-and-share/invite-your-team): Add collaborators to your project

* [**Publish**](/create/publish-and-share/publish): Launch your app live
...
* **Select mode**:
  ...
  * Create reusable [components](/create/builder-add-ons/components)

  * Add links between [pages](/create/builder-add-ons/pages)
...
[PreviousOverview](/create/builder-add-ons/overview)[NextPages](/create/builder-add-ons/pages)
