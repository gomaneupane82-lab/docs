...
- **Discussion Mode** - chat without making edits by clicking on the speech bubble icon labeled Discuss. It can be important at times to prevent edits to your work and be able to ask questions of the builder about status, approach or specific features without allowing it to alter your current design. 
