...
<Steps>
  ...
  <Step title="Test your app">
    Run through your flow in your published app, you can use Stripe Test Data to make a test purchase

    1. Verify when you hit the button in the Subscription Upsell, you're redirected to Stripe
    2. The stripe integration is setup in test mode. This means you can pay for products using test cards (e.g. 4242 4242 4242 4242), but no real transactions will occur.
