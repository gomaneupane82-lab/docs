...
<Steps>
  <Step title="Visit Create Dashboard -> Accept Payments">
    <img src="/images/stripe/dashboard.png" alt="Accept Payments" />
  </Step>
...
#### Stripe Checkout Link Component 
...
#### Stripe Authorization Wrapper Component 
...
You can use this component when describing things you only want paid users to see.  
...
<img src="/images/stripe/connect/stripe-test-mode.png" style={{ borderRadius: '0.5rem' }} />
...
<Steps>
  ...
  <Step title="Go to Product catalog">
    <img src="/images/stripe/connect/stripe-product-catalog.png" style={{ borderRadius: '0.5rem' }} />
  </Step>
  
  <Step title="+ Create product">
    <img src="/images/stripe/connect/stripe-create-product.png" style={{ borderRadius: '0.5rem' }} />
  </Step>
  
  <Step title="Add Product details">
    <img src="/images/stripe/connect/stripe-product-details.png" style={{ borderRadius: '0.5rem' }} />
...
<Steps>
  ...
  <Step title="Select Event">
    ...
    <img src="/images/stripe/connect/stripe-event-destination.png" style={{ borderRadius: '0.5rem' }} />
  </Step>
...
<Steps>
  <Step title="Add Checkout Component">
    Add the Checkout Component where you want the subscribe button
  </Step>
  
  <Step title="Use the Stripe Authorization Wrapper Component to gate features">
