...
<AccordionGroup>
  ...
  <Accordion title="Which AI model is the best?">
    Anthropic's Claude Sonnet remains our top choice for development and is currently the only model available in Create.
  </Accordion>
  ...
  <Accordion title="Can I host my app on Create? Will it scale to handle many users?">
    Yes, most users host their projects on Create. Click Publish in the top right to deploy. Your application will scale to handle many users. Contact us about Business or Enterprise plans for additional concerns.
  </Accordion>
  ...
  <Accordion title="What language does Create write code in under the hood?">
    Create generates JavaScript web applications using React/Next.js and backend serverless functions.
  </Accordion>
  ...
  <Accordion title="What is the difference between free vs. Create Pro?">
    Free includes a one-time credit allotment and daily generation limits. Create Pro provides renewing monthly credits, private projects, custom domains, and priority AI models. Choose your credit tier based on your needs.
  </Accordion>
  ...
  <Accordion title="How do I publish to iOS or Android?" defaultOpen="false">
    Currently in beta. Visit [this article](/builder/mobile) to learn more and contact us via [hello@create.xyz](mailto:hello@create.xyz) if you'd like to join the early access group.
  </Accordion>
</AccordionGroup>
...
<Expandable title="Glossary" defaultOpen>
  ...
  - **App** - Mobile applications listed and obtained from app stores, which you can build with Create
  - **Website** - Web pages, blogs, storefronts, or business pages that you can build with Create
  ...
  - **ReactJS** - The framework Create uses for coding, originally developed by Facebook
