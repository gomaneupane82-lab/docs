...
<AccordionGroup>
  ...
  <Accordion title="Can I add databases?">
    Yes. You can use our built in [Databases](/builder/databases-beta) by pressing / in the chat > Data > Create a database. Describe how you want to store the data and send the message. You can also connect an external database through Functions.
  </Accordion>
  ...
  <Accordion title="When should I use a Page vs. a Component vs. a Function vs. a Database vs. User accounts?">
    ...
    * [**Databases**](/builder/databases-beta) let you store data so your app saves what users do in it
