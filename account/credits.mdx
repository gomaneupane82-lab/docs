...
- Head to the [dashboard](https://createanything.com/dashboard), click on Subscription and Credits, and then click on "Earn Free Credits".
...
![Choose Plan](/images/auth/x/3-chooseplan.png)