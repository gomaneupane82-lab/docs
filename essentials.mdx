...
We enable this by default to improve the builder experience. The AI agent will work to not only translate your instructions into code, but also go well beyond that to help you investigate and research questions, even to lookup off site resources like hosted documentation. Think of it like hiring an expert to approach a query when you're not just trying to instruct an edit but rather discuss strategy, improvements or business goals for your application.
