...
## Deep Thinking Mode - on by default

The AI agent will work to help you investigate and research questions or commands to the best of its ability, even with off site resources like hosted documentation. Think of it like hiring an expert to approach a query when you're not just trying to instruct an edit but rather discuss strategy, improvements or business goals for your application. We enable this by default to improve the builder experience. 
