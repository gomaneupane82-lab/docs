...
<Steps>
  <Step title="Start the Conversation">
    Begin by telling the builder about your API needs:
  ...
  <Step title="Provide API Information">
    Paste the API documentation or connection details into the builder chat:
    
    - **API documentation URL**: Paste the link to the API docs
    - **Endpoint examples**: Share sample requests/responses
    - **Authentication method**: API keys, OAuth, etc.
    
    The builder will analyze the information and understand how to connect.
    ...
    **Example prompt:**
    ...
    I need to display current weather and 5-day forecast for the user's location. 
    Users should be able to search for weather in different cities."
    ```
  </Step>
  ...
  <Step title="Let the Builder Handle Integration">
    The builder will automatically:
    
    - Generate the necessary code for API calls
    - Create proper error handling
    - Set up loading states and user feedback
    - Integrate the API into your application flow
    
    Just describe what you want the API to do in your app!
  </Step>

  <Step title="Test and Refine">
    Test your API integration:
    
    - Use **[Preview Mode](/builder/controls#mode-switcher)** to test the full user experience
