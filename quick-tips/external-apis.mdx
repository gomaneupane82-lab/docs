...
---
<warn>
This article is outdated and will be updated soon to reflect new capabilities in Create to have the builder offload all primary work to connect to external APIs, just by showing it documentation.
</warn>
