...
<Warning>
    To send emails from a registered domain, you must verify your domain in Resend.<br></br>
...
<Steps>
  <Step title="Visit Resend Website">
    ...
    <img src="/images/resend/resend-signup.png" style={{ borderRadius: '0.5rem' }} />
  </Step>

  <Step title="Complete Registration">
    * Sign up with email/password
    * Verify your email address
    <img src="/images/resend/resend-auth.png" style={{ borderRadius: '0.5rem' }} />
  </Step>
</Steps>
...
<Steps>
  <Step title="Create New Key">
    If this is your first time generating an API key, this Get Started page will show.<br></br>
    Otherwise, navigate to the API Keys page.<br></br>
    1. Click "Add an API Key"
    
    <img src="/images/resend/resend-apigen.png" style={{ borderRadius: '0.5rem' }} />
  </Step>
  ...
  <Step title="Secure Your Key">
    ...
    <img src="/images/resend/resend-verify.png" style={{ borderRadius: '0.5rem' }} />
