...
<Steps>
  <Step title="Visit TripAdvisor Developer Portal">
    Go to [tripadvisor.com/developer](https://tripadvisor.com/developer) and click "Log in to get started"
...
<Note type="success">
  Your TripAdvisor integration is now ready! Use the `/TripAdvisor` command in chat to access travel information.
</Note>
