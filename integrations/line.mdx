...
<Steps>
  <Step title="Create a Line Official Account Manager">
    ...
    <img src="/images/line/line-login.png" style={{ borderRadius: '0.5rem', width: '624px', height: '303px' }} />
  </Step>
...
<Steps>
  ...
  <Step title="Webhook URL">
    Find your webhook URL path in the Page and Function Settings under the Publish button. Copy the URL of your Create Project and API path into the webhook URL.
