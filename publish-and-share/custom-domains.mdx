...
<Frame caption="Custom domain configuration in the Publish modal">
  <img src="/images/domains/modal.png" />
</Frame>
...
<Steps>
  <Step title="Publish your app">
    [Publish](/create/publish-and-share/publish) your Create app
  </Step>
  ...
  <Accordion title="AWS Route 53">
    ...
    <Steps>
      <Step title="Create a new record">
        <Frame>
          <img src="/images/domains/aws-create.png" />
        </Frame>
      </Step>
      <Step title="Configure A record">
        Select `A` for the record type and set `76.76.21.21` for the value.
        <Frame>
          <img src="/images/domains/aws-apex.png" />
        </Frame>
      </Step>
      <Step>Create another record like in Step 1</Step>
      <Step title="Add CNAME record">
        ...
        - Subdomain: `www`
        <Frame>
          <img src="/images/domains/aws-www.png" />
        </Frame>
      </Step>
    </Steps>
    ...
    <Frame>
      <img src="/images/domains/aws-final.png" />
    </Frame>
  ...
  <Accordion title="GoDaddy">
    ...
    <Steps>
      <Step title="Navigate to Domains">
        <Frame>
          <img src="/images/domains/godaddy-domains.png" />
        </Frame>
      </Step>
      <Step title="Add new record">
        <Frame>
          <img src="/images/domains/godaddy-add.png" />
        </Frame>
      </Step>
      <Step title="Configure records">
        Add both the A and CNAME records as shown:
        <Frame>
          <img src="/images/domains/godaddy-records.png" />
        </Frame>
      </Step>
    </Steps>
    ...
    Your final configuration should look like this:
    <Frame>
      <img src="/images/domains/godaddy-final.png" />
    </Frame>
  </Accordion>
</AccordionGroup>
