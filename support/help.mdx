...
<Steps>
  ...
  <Step>
    <h4>3. Use Discussion Mode</h4>
    <p>Switch to Discussion Mode and paste the error. The AI will attempt to reproduce, isolate, and fix the issue automatically. Allow time for testing and verification.</p>
  </Step>
  <Step>
