...
If you experience connection issues attempting to reach [Create.xyz](http://Create.xyz) or see an error such as "this site can't provide a secure connection" or "create.xyz sent an invalid response" this is typically caused by security measures on your network (such as at work with more strict wifi settings) where .xyz domains are globally blocked. Due to some bad actors who also have .xyz domains, there can be a general block for any domain with this domain extension. \
\
