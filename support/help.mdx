...
The Debug Agent helps you self-recover from code issues by analyzing errors and working to repair them. When you encounter problems in your app, simply inform the builder of the error by pasting it into the builder chat. 
