...
<Steps>
  ...
  <Step>
    ...
    <p>Switch to Discussion Mode and paste the error. The AI will analyze the issue and provide you with an ideal prompt to fix it. Copy this prompt for the next step.</p>
  </Step>
  <Step>
