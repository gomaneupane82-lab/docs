...
<Steps>
  ...
  <Step>
    <h4>3. Use Debug Mode</h4>
    <p>Switch to Debug Mode and paste the error. The AI will attempt to reproduce, isolate, and fix the issue automatically. Allow time for testing and verification.</p>
  </Step>
  <Step>
    <h4>4. Verify and Test</h4>
    <p>Refresh your preview after the debug process completes, then test the previously broken functionality to confirm the fix worked.</p>
  </Step>
</Steps>

<Note>
  Debug Mode is powered by GPT-5 and designed to be affordable in terms of credit consumption. Work through one error at a time for best results.
</Note>
