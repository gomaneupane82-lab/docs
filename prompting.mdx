...
Here are our top tips from the team and community on how to build great apps with Create.
...
✅ **Do:** \[image of page] - `Replicate this exactly: <page-image>. Details: [...more details on things you want it to copy]`

✅ **Do:** \[image of page] - `Make something with similar features to this: <page-image>. Details: [...more on specific things you want it to copy]`
...
[PreviousBasics](/create/getting-started/builder-basics)[NextFAQ](/create/getting-started/faq)
