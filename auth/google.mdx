...
Your app will get the user's email address, name, profile picture, and locale from their Google account.   

You'll need to configure some things on Google's side first, add the right keys to Create, and then customize your sign up experience to add Google as an option. 
