...
<Steps>
  ...
  <Step title="Add your domain as an Authorized JavaScript Origin and `[your-domain]/api/auth/callback/google` as an Authorized redirect URI">
    1. Add your domain as a Authorized JavaScript Origin
    2. Add `[your-domain]/api/auth/callback/google` as an Authorized redirect URI

    <img src="/images/auth/google/10-addauthorizedoriginsandredirecturis.png" style={{ borderRadius: '0.5rem' }} />

    <Warning>
      Make sure the domain is already associated with your Create project
    </Warning>
  </Step>
...
<Steps>
  ...
  <Step title="Add Google Credentials">
    ...
    <img src="/images/auth/google/17-addcredentials.png" style={{ borderRadius: '0.5rem' }} />
  </Step>
